...
exports.defaultRules = {
  required: {
    ...
    validate: function (val) {
      return !helpers.isBlank(val);
    },
  },
  email: {
    message: "Please enter a valid email address.",
    validate: function (val) {
      return helpers.testRegex(
        val,
  ...
  firstName: {
    ...
    validate: function (val) {
      return helpers.testRegex(val, /^[A-Za-z ,.'-]+$/i);
    },
  },
  lastName: {
    message: "Please enter a valid :attribute.",
  ...
  verifyPhoneCode: {
    ...
    validate: function (val) {
      return helpers.testRegex(val, /^([0-9]{6})$/);
    },
  },
  verifyEmailCode: {
    message: "Please enter a valid verification code.",
  ...
  cryptocurrencyAddress: {
    ...
    validate: function (val) {
      return helpers.validateWalletAddress(val);
    },
  },
  currency: {
    message: "The :attribute must be a valid currency.",
    validate: function (val) {
      return helpers.testRegex(val, /^[\$£€¥]?(\d{1,3})(\,?\d{3})*\.?\d{0,2}$/);
    },
  },
  street: {
    message: "Please enter a valid :attribute.",
    validate: function (val) {
      return helpers.testRegex(val, /^[a-zA-Z0-9\s,'-]*$/);
    },
  },
  town: {
    message: "Please enter a valid :attribute.",
  ...
  postCode: {
    message: "Please enter a valid :attribute.",
    validate: function (val) {
      return helpers.testRegex(val, /^[A-Z0-9_-]*$/);
    },
  },
  phoneNumber: {
    message: "Please enter a valid :attribute.",
    validate: function (val) {
      return (
        ...
        ) && !helpers.testRegex(val, /^\b(\d)\1{8,}\b$/)
      );
    },
  },
  ccNumber: {
