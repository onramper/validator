...
class OnramperValidator {
    ...
    validateField(field, inputValue, gateway) {
        const rules = gateway
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.modifyMessage = exports.humanizeFieldName = exports.isBlank = exports.testRegex = void 0;
...
exports.defaultRules = {
    ...
    firstName: {
        ...
        validate: (val) => typeof val === typeof "string",
    },
    lastName: {
        message: "The :attribute must be a string.",
        validate: (val) => typeof val === typeof "string",
    ...
    card_exp: {
        ...
        validate: (val) => helpers.testRegex(val, /^(([0]?[1-9]{1})|([1]{1}[0-2]{1}))\s?\/\s?(\d{2}|\d{4})$/),
    },
    card_num: {
